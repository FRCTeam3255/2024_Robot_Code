...
public class RobotPreferences {
  public static final class prefDrivetrain {
    ...
    public static final SN_DoublePreference driveP = new SN_DoublePreference("driveP", 0.2402346041055719);
    public static final SN_DoublePreference driveI = new SN_DoublePreference("driveI", 0.0);
    public static final SN_DoublePreference driveD = new SN_DoublePreference("driveD", 0.002402346041055718);
    ...
    public static final SN_DoublePreference driveKv = new SN_DoublePreference("driveKv", 0.10810557184750733);
