...
public class RobotPreferences {
  public static final class prefClimber {
    // - PID -
    public static final SN_DoublePreference climberS = new SN_DoublePreference("climberS", 0, Units.Value);
    public static final SN_DoublePreference climberV = new SN_DoublePreference("climberV", 0, Units.Value);
    public static final SN_DoublePreference climberG = new SN_DoublePreference("climberG", 0, Units.Value);
    public static final SN_DoublePreference climberP = new SN_DoublePreference("climberP", 40, Units.Value);
    public static final SN_DoublePreference climberI = new SN_DoublePreference("climberI", 0, Units.Value);
    public static final SN_DoublePreference climberD = new SN_DoublePreference("climberD", 0, Units.Value);
    ...
    public static final SN_DoublePreference climberCruiseVelocity = new SN_DoublePreference(
        "climberCruiseVelocity", 80, Units.Value);
    ...
    public static final SN_DoublePreference climberAcceleration = new SN_DoublePreference(
        "climberAcceleration", 160, Units.Value);
    /**
     * <b> Units: </b> Rotations per second per second per second (rps/s/s)
     */
    public static final SN_DoublePreference climberJerk = new SN_DoublePreference("climberJerk", 1600, Units.Value);
     ...
     * <b> Units: </b> Meters
     */
    public static final SN_DoublePreference climberMinPos = new SN_DoublePreference("climberMinPos", 0, Units.Meters);
    ...
    public static final SN_DoublePreference climberSupplyCurrentLimitCeilingAmps = new SN_DoublePreference(
        "climberSupplyCurrentLimitCeilingAmps", 1, Units.Value);
    public static final SN_DoublePreference climberSupplyCurrentThreshold = new SN_DoublePreference(
        "climberSupplyCurrentThreshold", 40, Units.Value);
    public static final SN_DoublePreference climberSupplyTimeThreshold = new SN_DoublePreference(
        "climberSupplyTimeThreshold", 0.1, Units.Value);

    // - Speeds -
    /**
     * <b> Units: </b> Percent Output
     */
    public static final SN_DoublePreference climberUpSpeed = new SN_DoublePreference("climberUpSpeed", 1, Units.Value);
    ...
    public static final SN_DoublePreference climberIsAtPositionTolerance = new SN_DoublePreference(
        "climberIsAtPositionTolerance", 0.2, Units.Value);

  }

  public static final class prefDrivetrain {
    // This PID is implemented on each module, not the Drivetrain subsystem.
    public static final SN_DoublePreference driveP = new SN_DoublePreference("driveP", 0.18, Units.Value);
    public static final SN_DoublePreference driveI = new SN_DoublePreference("driveI", 0.0, Units.Value);
    public static final SN_DoublePreference driveD = new SN_DoublePreference("driveD", 0.0, Units.Value);

    public static final SN_DoublePreference steerP = new SN_DoublePreference("steerP", 100, Units.Value);
    public static final SN_DoublePreference steerI = new SN_DoublePreference("steerI", 0.0, Units.Value);
    ...
    public static final SN_DoublePreference driveCurrentTimeThreshold = new SN_DoublePreference(
        "driveCurrentTimeThreshold", 0.1, Units.Value);
    ...
    public static final SN_DoublePreference steerCurrentTimeThreshold = new SN_DoublePreference(
        "steerCurrentTimeThreshold", 0.1, Units.Value);

    public static final SN_DoublePreference driveKv = new SN_DoublePreference("driveKv",
        (1 / 15.1), Units.Value);

    // This PID is implemented on the Drivetrain subsystem
    public static final SN_DoublePreference autoDriveP = new SN_DoublePreference("autoDriveP", 8, Units.Value);
    public static final SN_DoublePreference autoDriveI = new SN_DoublePreference("autoDriveI", 0, Units.Value);
    public static final SN_DoublePreference autoDriveD = new SN_DoublePreference("autoDriveD", 0.0, Units.Value);

    public static final SN_DoublePreference autoSteerP = new SN_DoublePreference("autoSteerP", 2.5, Units.Value);
    public static final SN_DoublePreference autoSteerI = new SN_DoublePreference("autoSteerI", 0.0, Units.Value);
    public static final SN_DoublePreference autoSteerD = new SN_DoublePreference("autoSteerD", 0.0, Units.Value);

    // Teleop Snapping to Rotation (Yaw)
    public static final SN_DoublePreference yawSnapP = new SN_DoublePreference("yawSnapP", 3, Units.Value);
    public static final SN_DoublePreference yawSnapI = new SN_DoublePreference("yawSnapI", 0, Units.Value);
    public static final SN_DoublePreference yawSnapD = new SN_DoublePreference("yawSnapD", 0, Units.Value);

    /**
     * <b>Units:</b> Percentage from 0 to 1
     */
    public static final SN_DoublePreference minimumSteerSpeedPercent = new SN_DoublePreference(
        "minimumSteerSpeedPercent", 0.01, Units.Value);
    ...
    public static final SN_DoublePreference measurementStdDevsPosition = new SN_DoublePreference(
        "measurementStdDevsPosition", 0.1, Units.Meters);
    ...
    public static final SN_DoublePreference measurementStdDevsHeading = new SN_DoublePreference(
        "measurementStdDevsHeading", 0.1, Units.Radians);
  }

  public static final class prefIntake {
    // - Configs -
    public static final SN_DoublePreference pivotS = new SN_DoublePreference("pivotS", 0.2, Units.Value);
    public static final SN_DoublePreference pivotG = new SN_DoublePreference("pivotG", 0.6, Units.Value);
    public static final SN_DoublePreference pivotA = new SN_DoublePreference("pivotA", 0.1, Units.Value);
    public static final SN_DoublePreference pivotP = new SN_DoublePreference("pivotP", 30, Units.Value); // 10
    public static final SN_DoublePreference pivotI = new SN_DoublePreference("pivotI", 0, Units.Value);
    public static final SN_DoublePreference pivotD = new SN_DoublePreference("pivotD", 0, Units.Value);
    ...
    public static final SN_DoublePreference pivotAcceleration = new SN_DoublePreference(
        "pivotAcceleration", 260, Units.Value);
    /**
     * <b> Units: </b> Rotations per second per second per second (rps/s/s)
     */
    public static final SN_DoublePreference pivotJerk = new SN_DoublePreference("climberJerk", 1600, Units.Value);
    ...
    public static final SN_DoublePreference rollerCurrentTimeThreshold = new SN_DoublePreference(
        "rollerCurrentTimeThreshold", 0.1, Units.Value);
    ...
    public static final SN_DoublePreference pivotCurrentTimeThreshold = new SN_DoublePreference(
        "pivotCurrentTimeThreshold", 0.1, Units.Value);
     ...
     * <b> Units: </b> Degrees
     */
    public static final SN_DoublePreference pivotMaxPos = new SN_DoublePreference("pivotMaxPos", 119, Units.Degrees);

    /**
     * <b> Units: </b> Degrees
     */
    public static final SN_DoublePreference pivotMinPos = new SN_DoublePreference("pivotMinPos", 0, Units.Degrees);
    ...
    public static final SN_DoublePreference rollerStageAmpNoteSpeed = new SN_DoublePreference(
        "rollerStageAmpNoteSpeed", -0.5, Units.Value);
    ...
    public static final SN_DoublePreference pivotStowAngle = new SN_DoublePreference(
        "pivotStowAngle", 75.5, Units.Value);
    ...
    public static final SN_DoublePreference pivotGroundIntakeAngle = new SN_DoublePreference(
        "pivotGroundIntakeAngle", 1, Units.Degrees);
  ...
  public static final class prefPitch {
    ...
    public static final SN_DoublePreference pitchS = new SN_DoublePreference("pitchS", 0.4, Units.Value);
    public static final SN_DoublePreference pitchG = new SN_DoublePreference("pitchG", 0.36, Units.Value);
    public static final SN_DoublePreference pitchA = new SN_DoublePreference("pitchA", 0.1, Units.Value);
    public static final SN_DoublePreference pitchP = new SN_DoublePreference("pitchP", 300, Units.Value);
    public static final SN_DoublePreference pitchI = new SN_DoublePreference("pitchI", 0, Units.Value);
    public static final SN_DoublePreference pitchD = new SN_DoublePreference("pitchD", 0, Units.Value);
    ...
    public static final SN_DoublePreference pitchCurrentTimeThreshold = new SN_DoublePreference(
        "pitchCurrentTimeThreshold", 0.1, Units.Value);
     ...
     * <b>Units:</b> Degrees
     */
    public static final SN_DoublePreference pitchAmpAngle = new SN_DoublePreference("pitchAmpAngle", 57.5, Units.Value);
     ...
     * <b>Units:</b> Degrees
     */
    public static final SN_DoublePreference pitchSubAngle = new SN_DoublePreference("pitchSubAngle", 55, Units.Value);
  ...
  public static final class prefShooter {
    public static final SN_DoublePreference leftShooterS = new SN_DoublePreference("leftShooterS", 0.4, Units.Value);
    public static final SN_DoublePreference leftShooterV = new SN_DoublePreference("leftShooterV", 0.12, Units.Value);
    public static final SN_DoublePreference leftShooterA = new SN_DoublePreference("leftShooterA", 0.1, Units.Value);
    public static final SN_DoublePreference leftShooterP = new SN_DoublePreference("leftShooterP", 0.6, Units.Value);
    public static final SN_DoublePreference leftShooterI = new SN_DoublePreference("leftShooterI", 0, Units.Value);
    public static final SN_DoublePreference leftShooterD = new SN_DoublePreference("leftShooterD", 0.01, Units.Value);

    public static final SN_DoublePreference rightShooterS = new SN_DoublePreference("rightShooterS", 0.4, Units.Value);
    public static final SN_DoublePreference rightShooterV = new SN_DoublePreference("rightShooterV", 0.1175,
        Units.Value);
    public static final SN_DoublePreference rightShooterA = new SN_DoublePreference("rightShooterA", 0.1, Units.Value);
    public static final SN_DoublePreference rightShooterP = new SN_DoublePreference("rightShooterP", 0.6, Units.Value);
    public static final SN_DoublePreference rightShooterI = new SN_DoublePreference("rightShooterI", 0, Units.Value);
    public static final SN_DoublePreference rightShooterD = new SN_DoublePreference("rightShooterD", 0.01, Units.Value);

    /**
     * <b>Units:</b> Rotations per second
     */
    public static final SN_DoublePreference shooterUpToSpeedTolerance = new SN_DoublePreference(
        "shooterUpToSpeedTolerance", 0.7, Units.Value);
  ...
  public static final class prefTransfer {
    ...
    public static final SN_DoublePreference feederHasGamePieceCurrent = new SN_DoublePreference(
        "feederHasGamePieceCurrent", -6, Units.Value);
    ...
    public static final SN_DoublePreference transferHasGamePieceCurrent = new SN_DoublePreference(
        "transferHasGamePieceCurrent", 8, Units.Value);
    ...
    public static final SN_DoublePreference transferHasGamePieceVelocity = new SN_DoublePreference(
        "transferHasGamePieceVelocity", 15, Units.Value);
    ...
    public static final SN_DoublePreference feederAutoHasGamePieceCurrent = new SN_DoublePreference(
        "feederAutoHasGamePieceCurrent", -7, Units.Value);
    ...
    public static final SN_DoublePreference transferAutoHasGamePieceCurrent = new SN_DoublePreference(
        "transferAutoHasGamePieceCurrent", 7, Units.Value);
  ...
  public static final class prefTurret {
    // -- PID & Configs--
    public static final SN_DoublePreference turretS = new SN_DoublePreference("turretS", 0.25, Units.Value);
    public static final SN_DoublePreference turretA = new SN_DoublePreference("turretA", 0.1, Units.Value);
    public static final SN_DoublePreference turretV = new SN_DoublePreference("turretV", 0.0, Units.Value);
    public static final SN_DoublePreference turretP = new SN_DoublePreference("turretP", 150, Units.Value);
    public static final SN_DoublePreference turretI = new SN_DoublePreference("turretI", 0, Units.Value);
    public static final SN_DoublePreference turretD = new SN_DoublePreference("turretD", 5, Units.Value);
  ...
  public static final class prefVision {
    ...
    public static final SN_DoublePreference multiTagStdDevsPosition = new SN_DoublePreference(
        "multiTagStdDevsPosition", 3, Units.Meters);
    ...
    public static final SN_DoublePreference multiTagStdDevsHeading = new SN_DoublePreference(
        "multiTagStdDevsHeading", 0.9, Units.Radians);
    ...
    public static final SN_DoublePreference singleTagStdDevsPosition = new SN_DoublePreference(
        "singleTagStdDevsPosition", 10, Units.Value);
    ...
    public static final SN_DoublePreference singleTagStdDevsHeading = new SN_DoublePreference(
        "singleTagStdDevsHeading", 3, Units.Value);
    ...
    public static final SN_DoublePreference translationalAutoPlacementTolerance = new SN_DoublePreference(
        "translationalAutoPlacementTolerance", 0.15, Units.Value);
    ...
    public static final SN_DoublePreference rotationalAutoPlacementTolerance = new SN_DoublePreference(
        "translationalAutoPlacementTolerance", 2, Units.Value);
  }
