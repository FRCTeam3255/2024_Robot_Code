...
public class Turret extends SubsystemBase implements Logged {
  ...
  public void configure() {
    ...
    turretConfig.MotionMagic.MotionMagicCruiseVelocity = prefTurret.turretCruiseVelocity.getValue(); // rps
    turretConfig.MotionMagic.MotionMagicAcceleration = prefTurret.turretAcceleration.getValue(); // rps/s
    turretConfig.MotionMagic.MotionMagicJerk = prefTurret.turretJerk.getValue(); // rps/s/s
